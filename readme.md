...
- 当前同步源：`../uya` 的 `1.0` 分支，提交 `337a0edd`
...
- `./uya/bin/cmd/build` 为 6,924,216 字节的动态链接编译器；同步时必须同时更新启动器和该子命令，不能只复制 `bin/uya`
- 当前同步产物 SHA256 分别为 `8ad1e481e45a65907b4ff02cac48646799d804e90ce794e9445680fc5e6359cf` 和 `e59d009b256a1067c16d09c03b2c696144efa4e202d930071afcf835daab8706`
- 本次同步、上游修复、兼容调整和验证结果见 [Uya 1.0 同步报告（2026-07-22）](docs/redis-uya-uya-sync-2026-07-22.md)
