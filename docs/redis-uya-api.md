...
- 当前实现为 partial，仅暴露 `ACL CAT`、`ACL HELP`、`ACL LIST`、`ACL USERS`、`ACL WHOAMI` 和 `COMMAND*` 可见面
- `COMMAND INFO/LIST/DOCS` 会暴露 `ACL`、`ACL|CAT`、`ACL|HELP`、`ACL|LIST`、`ACL|USERS` 与 `ACL|WHOAMI`
