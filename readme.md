...
- Hash 命令子集：`HSET`、`HGET`、`HDEL`、`HEXISTS`、`HLEN`、`HMGET`、`HSETNX`、`HSTRLEN`、`HRANDFIELD`，以及 field TTL 兼容面 `HGETEX/HSETEX/HEXPIRE/HPEXPIRE/HTTL/HPTTL/HEXPIRETIME/HPEXPIRETIME/HPERSIST`
...
- Hash 第三批扫描：`HSCAN`
- Hash field TTL 兼容面：`HGETEX`、`HSETEX`、`HEXPIRE`、`HPEXPIRE`、`HTTL`、`HPTTL`、`HEXPIRETIME`、`HPEXPIRETIME`、`HPERSIST`
