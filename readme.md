...
- `v0.9.2`：继续补 Redis Open Source 单机核心缺口，当前优先脚本第一批；`PFADD/PFCOUNT/PFMERGE` 已以 exact set-backed partial 形态落地，`GEOADD/GEODIST/GEOSEARCH` 已以 exact zset-backed partial 形态落地。
