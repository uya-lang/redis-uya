...
- ZSet 命令子集：`ZADD`、`ZRANGE`、`ZRANGEBYLEX`、`ZREMRANGEBYLEX`、`ZREVRANGE`、`ZREVRANGEBYLEX`、`ZLEXCOUNT`、`ZRANDMEMBER`、`ZREM`
...
- ZSet 第三批范围删除、扫描与随机读取：`ZREMRANGEBYLEX`、`ZREMRANGEBYRANK`、`ZREMRANGEBYSCORE`、`ZSCAN`、`ZRANDMEMBER`
