...
- 2026-07-19 当前 `HEAD`：`make test`、`make test-integration`、`make test-redis-cli` 与 release benchmark 绝对吞吐/p99 guard 通过；正式矩阵为 Redis 的 `0.97x/1.18x/1.05x/1.14x/1.00x`，短矩阵受同机 Redis 波动影响，完整超越仍待继续优化。
