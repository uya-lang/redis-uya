...
- Functions 第一批 partial：`FUNCTION HELP` 当前可用，用于暴露 Functions 控制面帮助和 `COMMAND*` 可见面；暂不支持 function library 存储、`FUNCTION LOAD/LIST/STATS/FLUSH` 或 `FCALL*`
