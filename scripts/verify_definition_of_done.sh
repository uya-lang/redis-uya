...
benchmark_v0_8_out="$(mktemp "$REPO_ROOT/build/benchmark-v0.8.0.XXXXXX.md")"
...
trap 'rm -f "$benchmark_v0_1_out" "$benchmark_v0_8_out" "$gap_v0_8_out" "$io_uring_v0_8_out"' EXIT
REDIS_UYA_BENCH_OUT="$benchmark_v0_1_out" python3 scripts/benchmark_v0_1_0.py
REDIS_UYA_BENCH_BASELINE=benchmarks/v0.8.0-performance.md REDIS_UYA_BENCH_OUT="$benchmark_v0_8_out" make benchmark-v0.8.0
