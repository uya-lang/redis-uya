...
- ZSet 命令子集：`ZADD`、`ZRANGE`、`ZRANGEBYLEX`、`ZREMRANGEBYLEX`、`ZREVRANGE`、`ZREVRANGEBYLEX`、`ZLEXCOUNT`、`ZRANDMEMBER`、`ZDIFF`、`ZDIFFSTORE`、`ZINTERCARD`、`ZREM`
...
- ZSet 第三批范围删除、扫描与读/写路径补齐：`ZREMRANGEBYLEX`、`ZREMRANGEBYRANK`、`ZREMRANGEBYSCORE`、`ZSCAN`、`ZRANDMEMBER`、`ZDIFF`、`ZDIFFSTORE`、`ZINTERCARD`
